...
public class Board extends JPanel implements ActionListener {
    ...
    private final int ALL_BLOCKS = 30;
    private final int RAND_POS = 87;
    private final int DELAY = 140;
    private final long OBSTACLES_FREQUENCY = 2000L;

    private Block player1 = new Player(false, true, false, false, 50, 50);
    private Block player2 = new Player(true, false, false, false, 500, 500);
    ...
    private void checkCollision(Block player1, Block player2) {
